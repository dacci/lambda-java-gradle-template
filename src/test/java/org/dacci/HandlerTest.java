...
public class HandlerTest {
  ...
  void handleRequest(final S3Event event) {
    ...
    assertThat(request.queueUrl(), is("https://queue"));
    assertThat(
        request.messageBody(),
        is("s3://lambda-artifacts-deafc19498e3f2df/b21b84d653bb07b05b1e6b33684dc11b"));
    assertThat(request.messageGroupId(), is("lambda-artifacts-deafc19498e3f2df"));
    assertThat(
